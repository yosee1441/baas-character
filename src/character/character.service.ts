...
import { CatalogCharacterCode, CatalogCharacterName } from './utils/enums';
...
export class CharacterService {
  ...
  findOneById(id: Character['id']): Character {
    ...
    if (!character)
      throw new NotFoundException({
        ...
        notification: [
          {
            code: CatalogCharacterCode.RM00001,
            description: CatalogCharacterName.RM00001,
  ...
  update(id: Character['id'], dto: UpdateCharacterDto) {
    const character = this.findOneById(id);
    ...
    if (dto.id && dto.id !== id)
      throw new BadRequestException({
        ...
        notification: [
          {
            code: CatalogCharacterCode.RM00002,
            description: CatalogCharacterName.RM00002,
  ...
  delete(id: Character['id']) {
    ...
    this.characters = this.characters.filter((currentCharacter) => {
